...
<body>
  ...
  <script>
    ...
    //             "display": "block"
    //         });
    //         questionDesc.html(quiz[currentNum].desc);
    //     };
    //     choicesTxt.each(function (i) {
    ...
    //         alert("정답을 선택해주세요.");
    //     } else {
    //         if (questions[currentNum].answer == select){
    //             //정답
    //             $(".result_img img").css("display","none");
    //             $(".result_img .o").css("display","block");
    //             $(".commentary_area").addClass("show");
    ...
    //         questions = randomValueFromArray(quizs);
