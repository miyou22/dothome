            ...
            <div class="board-page">
                <ul>
                  <?php
                    ...
                    //처음으로
                    if($page != 1) {
                      echo "<li><a href='review.php?page=1'>&lt;&lt;</a></li>";
                    }

                    //이전페이지
                    if($page != 1){
                      $prevPage = $page - 1;
                      echo "<li><a href='review.php?page={$prevPage}'>&lt;</a></li>";
                    }

                    for($i=$startPage; $i<=$endPage; $i++){
                      $active = '';
                      if($i == $page) $active = 'active';
                      echo "<li class='{$active}'><a href='review.php?page={$i}'>{$i}</a></li>";
                    }

                    //다음페이지
                    if($page != $endPage){
                      $nextPage = $page + 1;
                      echo "<li><a href='review.php?page={$nextPage}'>&gt;</a></li>";
                    }

                    //마지막으로
                    if($page != $boardTotalPage){
                      echo "<li><a href='review.php?page={$boardTotalPage}'>&gt;&gt;</a></li>";
                    }
                  ?>
                    <!-- <li><a href="#">&lt;</a></li>
